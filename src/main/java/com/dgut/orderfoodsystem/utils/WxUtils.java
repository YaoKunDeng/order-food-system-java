...
public class WxUtils {
    ...
    //加解密算法/模式/填充方式
    //ECV模式只用密钥即可对数据进行解密，CBC模式需要添加一个iv
    public static final String CIPHER_ALGORITHM = "AES/CBC/PKCS7Padding";

    //微信小程序--个人信息解密
    public WxUser getUserInfo(String encryptedData, String sessionKey, String iv){
        String result = "";
        WxUser wxUser = null;
        //被加密的数据
        ...
        try {
            ...
            wxUser = JSONObject.parseObject(result, WxUser.class);
